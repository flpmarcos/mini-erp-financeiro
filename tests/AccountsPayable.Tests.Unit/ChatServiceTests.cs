...
{
    private static (ChatService svc, ContasAPagar.Web.Data.AppDbContext db, NotificacaoService notif) Build()
    {
    ...
    public async Task ConversaVinculadaConta_EhAuditavel_E_AuditorAcessa()
    {
        ...
        var conta = new ContasAPagar.Web.Domain.Entities.ContaPagar
